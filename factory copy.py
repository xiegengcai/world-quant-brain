...
def first_order_factory(dataset_id:str, fields, ops_set):
    alpha_set = []
    #for field in fields:
    for field in fields:
...
def ts_factory(dataset_id:str, op, field):
    output = []
    ...
    for day in days:
        ...
        output.append({"dataset":dataset_id,"expression":alpha})
    
    return output
 
def ts_comp_factory(dataset_id:str, op, field, factor, paras):
    output = []
